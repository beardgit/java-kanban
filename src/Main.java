...
import app.handlers.HttpEpicHandler;
import app.handlers.HttpSubtaskHandler;
import app.handlers.HttpTaskHandler;
...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            server.createContext("/tasks", new HttpTaskHandler(Managers.getDefault()));
            server.createContext("/epics", new HttpEpicHandler());
            server.createContext("/subtask", new HttpSubtaskHandler());
